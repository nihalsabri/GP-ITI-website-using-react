            ...
            <div className="space-y-6 order-2 lg:order-1">
              ...
              <div className="space-y-4 text-gray-700 text-lg">
                <p className="leading-relaxed text-[16px]">
                  Our tradespeople represent the highest standard of quality and professionalism. With exceptional workmanship, outstanding customer service, and consistently top-rated reviews, these experts have earned their place on our website
                </p>
                <p className="leading-relaxed text-[16px]">
                 When you choose a tradesperon through Tradesmen Online, you’re choosing peace of mind, knowing your project is in the hands of someone who delivers excellence every time
                </p>
              </div>
